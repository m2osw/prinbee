...
void snapdatabase::bootstrap(snap_child * snap)
{
    ...
    SNAP_LISTEN(snapdatabase, "server", snap_manager::manager, retrieve_status, std::placeholders::_1);
    SNAP_LISTEN(snapdatabase, "server", snap_manager::manager, handle_affected_services, std::placeholders::_1);
}
